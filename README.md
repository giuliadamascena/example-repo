...
4. for the visual, to implement and image to the website i created an <figure> elemtn witj the image URL.
   <ins>As far as the leyout of the wesite itself, it was devided in parts, such as the head of the webside, the main body, and the footer</ins>
